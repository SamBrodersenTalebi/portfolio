    ...
    return(
       <div id="About me">
         ...
         <div className="flex-container">
            <div className="text">
              <h3>Udacity</h3>
              <p>I firstly started coding at Udacity where I enrolled the course "Introduction to Programming". I learned the basics of programming through HTML, CSS and Python.</p>
            </div>
            <div className="text"> 
              <h3>Codecademy</h3>
              <p> After finishing the course at Udacity I took two courses at Codecademy. The first course was "Build Websites from Scracth" where I learned to design and build responsive websites using CSS and HTML. 
The second course was "Build Front-End Web Applications from Scracth" using ReactJS and JavaScript. </p>
            </div>
            <div className="text"> 
              <h3>OpenClassrooms</h3>
              <p>I am currently studying Front-End Development at OpenClassrooms. The path is completed online with the help of a mentor who guides you through the projects. Each project consists of context details and customer requirements.
